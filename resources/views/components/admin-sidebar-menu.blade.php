...
<aside x-data="sidebarTheme()" :data-theme="theme"
    ...
    <nav class="flex-1 py-2 px-2 overflow-y-auto sidebar-nav"
        ...
        @if(!$hasActiveRole(['oqituvchi', 'tyutor']))
        @php
        ...
        @if(($isTeacher || $hasActiveRole(['superadmin', 'admin', 'kichik_admin', 'registrator_ofisi', 'dekan', 'oqituvchi', 'kafedra_mudiri', 'fan_masuli'])) && !$hasActiveRole(['oquv_bolimi', 'oquv_bolimi_boshligi', 'tyutor']))
        ...
        <a href="{{ route('admin.registrator.face-check.index') }}"
           class="sidebar-link {{ request()->routeIs('admin.registrator.face-check.*') ? 'sidebar-active' : '' }}">
            <svg class="w-5 h-5 mr-3 sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {{-- Dekan/registrator bularni o'z "Qo'shimcha" bo'limidan oladi
             (pastdagi @elseif blokda). Bu yerda — qolgan rollarga. --}}
        @if($hasActiveRole(['superadmin', 'admin', 'kichik_admin', 'tyutor']))
        ...
        @if($hasActiveRole(['superadmin', 'admin', 'kichik_admin']))
        <a href="{{ route('admin.dean-exam-reschedule.index') }}"
           class="sidebar-link {{ request()->routeIs('admin.dean-exam-reschedule*') ? 'sidebar-active' : '' }}">
            <svg class="w-5 h-5 mr-3 sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
            </svg>
            Kech qolgan talabani ko'chirish
        </a>
        @endif
        ...
        @if($hasActiveRole(['superadmin', 'admin', 'kichik_admin', 'registrator_ofisi']))
        <a href="{{ route('admin.vedomost-submission.index') }}"
           class="sidebar-link {{ request()->routeIs('admin.vedomost-submission.*') ? 'sidebar-active' : '' }}">
            <svg class="w-5 h-5 mr-3 sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
            </svg>
            Vedomost topshirish
        ...
        <a href="{{ $r('admin.kunlik-monitoring.index', 'teacher.kunlik-monitoring.index') }}"
           class="sidebar-link {{ $isActive('admin.kunlik-monitoring.*', 'teacher.kunlik-monitoring.*') ? 'sidebar-active' : '' }}">
            <svg class="w-5 h-5 mr-3 sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
            </svg>
            Kunlik monitoring
        ...
        <a href="{{ route('admin.reports.manual-retake-gaps') }}"
           class="sidebar-link {{ request()->routeIs('admin.reports.manual-retake-gaps*') ? 'sidebar-active' : '' }}">
            <svg class="w-5 h-5 mr-3 sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
            </svg>
            Yarim otrabotka
        ...
        @if($hasActiveRole(['superadmin', 'admin', 'kichik_admin', 'registrator_ofisi', 'oquv_bolimi', 'oquv_bolimi_boshligi', 'kafedra_mudiri']))
        ...
        @if(!$hasActiveRole(['test_markazi', 'oquv_bolimi', 'oquv_bolimi_boshligi', 'oqituvchi', 'tyutor', 'nazoratchi']) && !auth()->guard('teacher')->check())
        ...
        @if($hasActiveRole(['superadmin', 'admin', 'kichik_admin', 'registrator_ofisi']))
        <a href="{{ route('admin.reports.retake-not-applied') }}"
           class="sidebar-link {{ request()->routeIs('admin.reports.retake-not-applied*') ? 'sidebar-active' : '' }}">
            <svg class="w-5 h-5 mr-3 sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {{-- Qayta o'qish arizalari (Dekan + Registrator) --}}
        <a href="{{ route('admin.retake.index') }}"
           class="sidebar-link {{ request()->routeIs('admin.retake.*') ? 'sidebar-active' : '' }}" style="position: relative;">
            <svg class="w-5 h-5 mr-3 sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {{-- O'quv bo'limi: qayta o'qish boshqaruvi --}}
        @if($hasActiveRole(['superadmin', 'admin', 'oquv_bolimi', 'oquv_bolimi_boshligi']))
        <a href="{{ route('admin.retake-sessions.index') }}"
           class="sidebar-link {{ request()->routeIs('admin.retake-sessions.*') ? 'sidebar-active' : '' }}">
            <svg class="w-5 h-5 mr-3 sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('admin.retake-statistics.index') }}"
           class="sidebar-link {{ request()->routeIs('admin.retake-statistics.*') ? 'sidebar-active' : '' }}">
            <svg class="w-5 h-5 mr-3 sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {{-- Fan statistikasi: faqat O'quv bo'limi --}}
        @if($hasActiveRole(['superadmin', 'admin', 'oquv_bolimi', 'oquv_bolimi_boshligi']))
        <a href="{{ route('admin.retake-teacher-subjects.index') }}"
           class="sidebar-link {{ request()->routeIs('admin.retake-teacher-subjects.*') ? 'sidebar-active' : '' }}">
            <svg class="w-5 h-5 mr-3 sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('admin.face-id.logs') }}"
           class="sidebar-link {{ request()->routeIs('admin.face-id.logs*') ? 'sidebar-active' : '' }}">
            <svg class="w-5 h-5 mr-3 sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {{-- Beacon davomat — eng pastda, alohida bo'lim --}}
        @php
            $canOpenAttendance = !$hasActiveRole('javobgar_firma')
                && ($isTeacher || $hasActiveRole(['superadmin', 'admin', 'kichik_admin', 'registrator_ofisi', 'dekan', 'oqituvchi', 'kafedra_mudiri', 'fan_masuli']))
                && !$hasActiveRole(['oquv_bolimi', 'oquv_bolimi_boshligi', 'tyutor']);
            $canManageBeacons = $hasActiveRole(['superadmin', 'admin', 'kichik_admin']);
        @endphp
        @if($canOpenAttendance || $canManageBeacons)
        <div class="sidebar-section">Beacon davomat</div>
        @endif

        @if($canOpenAttendance)
        <a href="{{ route('admin.attendance.index') }}"
           class="sidebar-link {{ request()->routeIs('admin.attendance.*') ? 'sidebar-active' : '' }}">
            <svg class="w-5 h-5 mr-3 sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
            </svg>
            Davomat
        ...
        @if($canManageBeacons)
        <a href="{{ route('admin.beacons.index') }}"
           class="sidebar-link {{ request()->routeIs('admin.beacons.*') ? 'sidebar-active' : '' }}">
            <svg class="w-5 h-5 mr-3 sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
