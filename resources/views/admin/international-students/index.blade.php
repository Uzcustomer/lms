    ...
    <x-slot name="header">
        <div style="display:flex;align-items:center;justify-content:space-between;gap:8px;flex-wrap:wrap;">
            ...
            <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
                <a href="{{ route('admin.visa-applications.index') }}" style="display:inline-flex;align-items:center;gap:5px;padding:6px 14px;font-size:12px;font-weight:600;color:#0369a1;background:#e0f2fe;border:1px solid #bae6fd;border-radius:8px;text-decoration:none;transition:all 0.15s;" onmouseover="this.style.background='#bae6fd'" onmouseout="this.style.background='#e0f2fe'">
                    ...
                    Viza arizalar
                    @if(($visaPendingCount ?? 0) > 0)
                        <span style="background:#dc2626;color:#fff;font-size:10px;font-weight:bold;padding:1px 6px;border-radius:999px;margin-left:2px;">{{ $visaPendingCount }}</span>
                    @endif
                </a>
