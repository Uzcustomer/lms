        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            @if(!$student->is_graduate)
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
                    ...
                    <p class="text-yellow-700 font-medium">Ishga joylashish shartnomasi faqat bitiruvchi kurs talabalari uchun mavjud.</p>
                </div>
            @elseif($contracts->isEmpty())
                <div class="bg-white rounded-lg shadow-sm p-12 text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-700 mb-2">Ishga joylashish shartnomasi mavjud emas</h3>
                    <p class="text-gray-500 mb-4">Ishga joylashish shartnomasi uchun ariza yuborishingiz mumkin.</p>
                    <a href="{{ route('student.contracts.create') }}"
