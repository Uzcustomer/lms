    ...
    Route::middleware([\App\Http\Middleware\AdminMultiGuardAuth::class, \Spatie\Permission\Middleware\RoleMiddleware::class . ':superadmin|admin|kichik_admin|inspeksiya|oquv_prorektori|registrator_ofisi|oquv_bolimi|oquv_bolimi_boshligi|buxgalteriya|manaviyat|tyutor|nazoratchi|dekan|kafedra_mudiri|fan_masuli|oqituvchi|test_markazi|javobgar_firma'])->group(function () {
        ...
        Route::middleware(\Spatie\Permission\Middleware\RoleMiddleware::class . ':superadmin|admin|registrator_ofisi|oquv_bolimi|oquv_bolimi_boshligi|oquv_prorektori')
            ...
            ->group(function () {
                ...
                Route::post('/applications/{application}/move-to-transfer', [\App\Http\Controllers\Admin\AcademicMobilityController::class, 'moveToTransfer'])->name('move-to-transfer');
        ...
        Route::prefix('contracts')->name('contracts.')->group(function () {
            ...
            Route::get('/get-groups', [ContractController::class, 'getGroups'])->name('get-groups');
        });
        ...
        Route::prefix('international-students')->name('international-students.')->group(function () {
            ...
            Route::post('/toggle-visa-block', [\App\Http\Controllers\Admin\InternationalStudentController::class, 'toggleVisaBlock'])->name('toggle-visa-block');
            ...
            Route::post('/download-documents', [\App\Http\Controllers\Admin\InternationalStudentController::class, 'downloadDocuments'])->name('download-documents');
            // Bir nechta talabaning registratsiya/viza jarayonini birdan o'zgartirish
            Route::post('/bulk-process', [\App\Http\Controllers\Admin\InternationalStudentController::class, 'bulkProcess'])->name('bulk-process');
            ...
            Route::post('/{student}/store-visa', [\App\Http\Controllers\Admin\InternationalStudentController::class, 'storeVisa'])->name('store-visa');
            Route::post('/{student}/assign-firm', [\App\Http\Controllers\Admin\InternationalStudentController::class, 'assignFirm'])->name('assign-firm');
        ...
        Route::prefix('dars-jadvali-tuzish')->name('timetable.')
            ->middleware([\Spatie\Permission\Middleware\RoleMiddleware::class . ':superadmin|admin|kichik_admin|registrator_ofisi|oquv_bolimi|oquv_bolimi_boshligi|kafedra_mudiri', \App\Http\Middleware\TimetableAssignmentAccess::class])
            ->group(function () {
                ...
                Route::get('/boards/{board}/unplaced-export', [\App\Http\Controllers\Admin\TimetableController::class, 'unplacedExport'])->name('boards.unplaced-export');
        ...
        Route::prefix('retake')->name('retake.')->group(function () {
            ...
            Route::post('/applications/bulk-decide', [\App\Http\Controllers\Teacher\RetakeApprovalController::class, 'bulkDecide'])->name('applications.bulk-decide');
        ...
        Route::prefix('retake-groups')->name('retake-groups.')->group(function () {
            ...
            Route::get('/trashed', [\App\Http\Controllers\Teacher\AcademicDept\RetakeGroupController::class, 'trashed'])->name('trashed');
            ...
            Route::delete('/{groupId}/force', [\App\Http\Controllers\Teacher\AcademicDept\RetakeGroupController::class, 'forceDestroy'])->name('force-destroy');
    ...
    Route::middleware(['auth:teacher', 'force.password.change', \Spatie\Permission\Middleware\RoleMiddleware::class . ':superadmin|admin|kichik_admin|inspeksiya|oquv_prorektori|registrator_ofisi|oquv_bolimi|oquv_bolimi_boshligi|buxgalteriya|manaviyat|tyutor|nazoratchi|dekan|kafedra_mudiri|fan_masuli|oqituvchi|test_markazi'])->group(function () {
        ...
        Route::prefix('test-collections')->name('fan-testlari.')
            ...
            ->group(function () {
                ...
                Route::delete('/attempts/{attempt}', [FanTestiController::class, 'destroyAttempt'])->name('attempts.destroy');
                Route::delete('/{fanTesti}/attempts', [FanTestiController::class, 'clearAttempts'])->name('attempts.clear');
