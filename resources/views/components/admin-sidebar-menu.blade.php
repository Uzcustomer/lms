...
<aside x-data="sidebarTheme()" :data-theme="theme"
    ...
    <nav class="flex-1 py-2 px-2 overflow-y-auto sidebar-nav"
        ...
        @elseif(!$hasActiveRole(['kafedra_mudiri', 'tyutor']) && !auth()->guard('teacher')->check())
        ...
        @if(!$hasActiveRole(['test_markazi', 'oquv_bolimi', 'oquv_bolimi_boshligi', 'oqituvchi', 'tyutor']) && !auth()->guard('teacher')->check())
