...
<div class="min-h-screen bg-gray-100 dark:bg-gray-900">
    ...
    <div x-data="{ boshqalarOpen: false }" class="sm:hidden" style="position:fixed !important;bottom:0 !important;left:0 !important;right:0 !important;z-index:9999 !important;">
        ...
        <!-- Boshqalar radial fan menu — o'ng pastdan yarim doira ochiladi -->
        <div style="position:absolute;bottom:100%;right:0.5rem;margin-bottom:0.25rem;z-index:9999;pointer-events:none;">
            <!-- 1. Sababli ariza — chapga (225°) -->
            <a href="{{ route('student.absence-excuses.index') }}"
               x-show="boshqalarOpen"
               style="position:absolute;bottom:0;right:0;display:none;pointer-events:auto;transition:transform 0.3s cubic-bezier(0.34,1.56,0.64,1),opacity 0.25s ease;"
               :style="boshqalarOpen ? 'transform:translate(-110px, -90px);opacity:1;' : 'transform:translate(0,0);opacity:0;'"
               class="flex flex-col items-center gap-1">
                <div class="w-12 h-12 rounded-xl flex items-center justify-center shadow-lg" style="background-color:#23417b;">
                ...
                <span class="text-[10px] font-semibold text-white" style="text-shadow:0 1px 3px rgba(0,0,0,0.5);">Ariza</span>
            </a>
            <!-- 2. Davomat — tepaga (270°) -->
            <a href="{{ route('student.attendance') }}"
               x-show="boshqalarOpen"
               style="position:absolute;bottom:0;right:0;display:none;pointer-events:auto;transition:transform 0.3s cubic-bezier(0.34,1.56,0.64,1) 0.05s,opacity 0.25s ease 0.05s;"
               :style="boshqalarOpen ? 'transform:translate(-40px, -130px);opacity:1;' : 'transform:translate(0,0);opacity:0;'"
               class="flex flex-col items-center gap-1">
                <div class="w-12 h-12 rounded-xl flex items-center justify-center shadow-lg" style="background-color:#23417b;">
                    <svg class="w-6 h-6" fill="none" stroke="white" stroke-width="1.8" viewBox="0 0 24 24">
                ...
                <span class="text-[10px] font-semibold text-white" style="text-shadow:0 1px 3px rgba(0,0,0,0.5);">Davomat</span>
            </a>
            <!-- 3. Qayta topshirish — o'ngga tepaga (315°) -->
            <a href="{{ route('student.pending-lessons') }}"
               x-show="boshqalarOpen"
               style="position:absolute;bottom:0;right:0;display:none;pointer-events:auto;transition:transform 0.3s cubic-bezier(0.34,1.56,0.64,1) 0.1s,opacity 0.25s ease 0.1s;"
               :style="boshqalarOpen ? 'transform:translate(20px, -120px);opacity:1;' : 'transform:translate(0,0);opacity:0;'"
               class="flex flex-col items-center gap-1">
                <div class="w-12 h-12 rounded-xl flex items-center justify-center shadow-lg" style="background-color:#23417b;">
                    <svg class="w-6 h-6" fill="none" stroke="white" stroke-width="1.8" viewBox="0 0 24 24">
                ...
                <span class="text-[10px] font-semibold text-white" style="text-shadow:0 1px 3px rgba(0,0,0,0.5);">Qayta</span>
            </a>
        </div>
        ...
        <div class="flex items-end justify-between px-4 pt-2" style="background-color:#23417b;padding-bottom:max(0.5rem, env(safe-area-inset-bottom));">
            <!-- 1. Fanlar -->
            <a href="{{ route('student.subjects') }}" class="flex flex-col items-center justify-center w-14 gap-0.5">
                @if($activeTab === 'fanlar')
                    <div class="w-9 h-9 rounded-lg flex items-center justify-center bg-white">
            ...
            <!-- 2. Dars jadvali -->
            <a href="{{ route('student.schedule') }}" class="flex flex-col items-center justify-center w-14 gap-0.5">
                @if($activeTab === 'jadval')
                    <div class="w-9 h-9 rounded-lg flex items-center justify-center bg-white">
                        <svg class="w-5 h-5" fill="none" stroke="#23417b" stroke-width="2" viewBox="0 0 24 24">
            ...
            <!-- 3. Asosiy -->
            <a href="{{ route('student.dashboard') }}" class="flex flex-col items-center justify-center w-14 gap-0.5">
                @if($activeTab === 'asosiy')
                    <div class="w-9 h-9 rounded-lg flex items-center justify-center bg-white">
                        <svg class="w-5 h-5" fill="none" stroke="#23417b" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="{{ route('student.independents') }}" class="flex flex-col items-center justify-center w-14 gap-0.5">
                @if($activeTab === 'mt')
                    <div class="w-9 h-9 rounded-lg flex items-center justify-center bg-white">
                        <svg class="w-5 h-5" fill="none" stroke="#23417b" stroke-width="2" viewBox="0 0 24 24">
            ...
            <button @click="boshqalarOpen = !boshqalarOpen" class="flex flex-col items-center justify-center w-14 gap-0.5">
