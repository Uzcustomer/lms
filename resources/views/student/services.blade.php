        ...
        <div class="grid grid-cols-2 gap-3">
            ...
            <a href="{{ route('student.absence-excuses.index') }}"
               ...
               style="padding:16px 10px; box-shadow: 0 4px 14px rgba(59, 130, 246, 0.25);">
                ...
                <span class="text-sm font-bold text-gray-800 text-center leading-tight">{{ __('Sababli ariza') }}</span>
                <span class="text-[11px] text-gray-400 mt-1 text-center">{{ __('Dars qoldirish arizasi') }}</span>
            </a>
            ...
            <a href="{{ route('student.appeals.index') }}"
               ...
               style="padding:16px 10px; box-shadow: 0 4px 14px rgba(59, 130, 246, 0.25);">
                ...
                <span class="text-sm font-bold text-gray-800 text-center leading-tight">{{ __('Apellyatsiya') }}</span>
                <span class="text-[11px] text-gray-400 mt-1 text-center">{{ __("Imtihon natijalari bo'yicha") }}</span>
            </a>
            ...
            <a href="{{ route('student.passport.index') }}"
               ...
               style="padding:16px 10px; box-shadow: 0 4px 14px rgba(59, 130, 246, 0.25);">
                ...
                <span class="text-sm font-bold text-gray-800 text-center leading-tight">{{ __("Pasport ma'lumotlari") }}</span>
                <span class="text-[11px] text-gray-400 mt-1 text-center">{{ __('Shaxsiy hujjatlar') }}</span>
            </a>
            @endif
            ...
            {{-- Nogironlik ma'lumotlari (faqat nogiron talabalar uchun) --}}
            @if(method_exists(Auth::guard('student')->user(), 'isDisabled') && Auth::guard('student')->user()->isDisabled())
            <a href="{{ route('student.disability-info.index') }}"
               class="flex flex-col items-center bg-white rounded-xl border border-gray-200 overflow-hidden active:scale-[0.98] transition-all duration-150"
               style="padding:16px 10px; box-shadow: 0 4px 14px rgba(245, 158, 11, 0.25);">
                <div class="w-14 h-14 rounded-2xl bg-amber-100 flex items-center justify-center mb-3">
                ...
                <span class="text-sm font-bold text-gray-800 text-center leading-tight">{{ __("Nogironlik ma'lumotlari") }}</span>
                <span class="text-[11px] text-gray-400 mt-1 text-center">{{ __("Mening ma'lumotlarim") }}</span>
            </a>
            @endif
            ...
            <a href="{{ route('student.clubs') }}"
               ...
               style="padding:16px 10px; box-shadow: 0 4px 14px rgba(59, 130, 246, 0.25);">
                ...
                <span class="text-sm font-bold text-gray-800 text-center leading-tight">To'garaklar</span>
