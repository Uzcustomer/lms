                ...
                <form id="filter-form" method="GET" action="{{ route('admin.journal.index') }}" class="p-6 bg-gray-50">
                    ...
                    <div class="flex flex-col items-start justify-between gap-4 mt-6 sm:flex-row sm:items-center">
                        <div class="w-full sm:w-auto">
                            ...
                            <select id="per_page" name="per_page" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm sm:mt-0 sm:w-auto focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                    ...
                    populateDropdown(
                        ...
                        () => {
                            if (selectedSemesterCode) {
                                $('#semester_code').val(selectedSemesterCode).trigger('change.select2');
                            }
                        }
                    );
                }
