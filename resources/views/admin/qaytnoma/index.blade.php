    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            @if(auth()->user()->hasRole(['admin']))
                ...
                <a href="{{ route('admin.qaytnoma.create') }}" class="btn btn-primary">
                    {{ __('YN oldi qaydnoma qo\'shish') }}
                </a>
            @endif
    ...
    <div class="py-12">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <form id="search-form" method="GET" action="{{ route('admin.qaytnoma.index') }}" class="p-6 bg-gray-50">
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                    @if(auth()->user()->hasRole(['admin']))
                                                        ...
                                                        <form action="{{ route('admin.qaytnoma.delete', $qaytnoma->id) }}"
                                                        ...
                                                        <a type="button" href="{{ route('admin.qaytnoma.edit', $qaytnoma->id) }}"
