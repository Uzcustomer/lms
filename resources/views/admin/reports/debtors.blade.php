        ...
        function showDetail(idx) {
            ...
            if (r.debts && r.debts.length) {
                for (var d = 0; d < r.debts.length; d++) {
                    ...
                    html += '<td class="' + (debt.jb < 60 ? 'cell-fail' : 'cell-pass') + '">' + debt.jb + '</td>';
                    html += '<td class="' + (debt.mt < 60 ? 'cell-fail' : 'cell-pass') + '">' + debt.mt + '</td>';
                    html += '<td class="' + (debt.on !== null && debt.on < 60 ? 'cell-fail' : 'cell-pass') + '">' + (debt.on !== null ? debt.on : '-') + '</td>';
                    html += '<td class="' + (debt.jn_percent < 60 ? 'cell-fail' : 'cell-pass') + '" style="font-weight:700;">' + debt.jn_percent + '</td>';
                    html += '<td class="' + (debt.oski !== null && debt.oski < 60 ? 'cell-fail' : 'cell-pass') + '">' + (debt.oski !== null ? debt.oski : '-') + '</td>';
                    html += '<td class="' + (debt.test !== null && debt.test < 60 ? 'cell-fail' : 'cell-pass') + '">' + (debt.test !== null ? debt.test : '-') + '</td>';
