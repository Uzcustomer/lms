<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @php
                $isMine = $application->registrar_status?->value === 'pending';
            @endphp

            @include('admin.retake._partials.application-detail', [
                'application' => $application,
                'approveRoute' => $isMine ? 'admin.retake.registrar.approve' : null,
                'rejectRoute' => $isMine ? 'admin.retake.registrar.reject' : null,
                'downloadFileRoute' => 'admin.retake.registrar.download-file',
            ])
