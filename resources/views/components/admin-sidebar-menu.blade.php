...
<aside x-data="sidebarTheme()" :data-theme="theme"
    ...
    <nav class="flex-1 py-2 px-2 overflow-y-auto sidebar-nav"
        ...
        <a href="{{ route('admin.face-id.settings') }}"
           class="sidebar-link {{ request()->routeIs('admin.face-id.settings') || request()->routeIs('admin.face-id.students') || request()->routeIs('admin.face-id.enrollment') ? 'sidebar-active' : '' }}">
            <svg class="w-5 h-5 mr-3 sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
