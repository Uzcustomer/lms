...
class TeacherMainController extends Controller
{
    ...
    public function index()
    {
        ...
        [$tutorStats, $gradingTimeStats, $workloadStats, $snapshotGeneratedAt] = $this->loadDashboardSnapshot($teacher);

        return view('teacher.dashboard', compact('tutorStats', 'gradingTimeStats', 'workloadStats', 'snapshotGeneratedAt'));
    }
    ...
    private function loadDashboardSnapshot($teacher): array
    {
        ...
        return [$tutorStats, $gradingTimeStats, $workloadStats, $generatedAt];
    }
