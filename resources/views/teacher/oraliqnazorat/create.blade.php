<x-teacher-app-layout>
        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form id="lessonForm" action="{{ route('teacher.oraliqnazorat.store') }}" method="POST"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block mb-2">O'qituvchi tanlang</label>
                                <select name="teacher_id" id="teacher_id" class="w-full rounded-md select2">
    ...
    <script>
        $(document).ready(function () {
            ...
            const lastFilters = @json(session('oraliq_nazorat_filter', []));
        ...
        @if(request('department_id')) $('#department_id').val('{{ request('
