<x-teacher-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('teacher.oski.create') }}" class="btn btn-primary">
                {{ __('OSKI qo\'shish') }}
            </a>
    ...
    <div class="py-12">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <form id="search-form" method="GET" action="{{ route('teacher.oski.index') }}" class="p-6 bg-gray-50">
                                ...
                                $shakllar = [
                                    ...
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            ...
                                            <a type="button" href="{{ route('teacher.oski.grade', $oski->id) }}"
