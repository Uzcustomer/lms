<x-guest-layout>
    ...
    <div style="margin-top: 16px; text-align: center;">
        ...
        <a href="{{ route('hemis.oauth.student.redirect') }}"
    ...
    <p style="margin-top: 12px; font-size: 11px; color: #9ca3af; line-height: 1.5;">
        HEMIS login va parol bilan kiring yoki HEMIS OAuth tugmasini bosing. Parol esdan chiqqan bo'lsa, dekanatga murojaat qiling.
    </p>
