    ...
    Route::middleware([\App\Http\Middleware\AdminMultiGuardAuth::class, \Spatie\Permission\Middleware\RoleMiddleware::class . ':superadmin|admin|kichik_admin|inspeksiya|oquv_prorektori|registrator_ofisi|oquv_bolimi|oquv_bolimi_boshligi|buxgalteriya|manaviyat|tyutor|nazoratchi|dekan|kafedra_mudiri|fan_masuli|oqituvchi|test_markazi|javobgar_firma'])->group(function () {
        ...
        Route::prefix('dars-jadvali-tuzish')->name('timetable.')
            ...
            ->group(function () {
                ...
                // Umumiy (klinik) kartani kafedra ajratishi: ma'ruza haftalari + ma'ruza o'qituvchisi/xonasi
                Route::post('/cards/{card}/split', [\App\Http\Controllers\Admin\TimetableController::class, 'splitCard'])->name('cards.split');
        ...
        Route::prefix('oquv-reja')->name('oquv-reja.')
            ...
            ->group(function () {
                ...
                Route::post('/set-clinical', [\App\Http\Controllers\Admin\CurriculumCheckController::class, 'setClinical'])->name('set-clinical');
