<x-teacher-app-layout>
        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form id="lessonForm" action="{{ route('teacher.oski.store') }}" method="POST"
    ...
    <script>
        $(document).ready(function () {
            ...
            const lastFilters = @json(session('oski_add_filter', []));
            ...
            $('#subject_id').change(function () {
                ...
                if (semester_id && groupId && subject_id) {
                    $.ajax({
                        url: '{{ route("teacher.get-shakl_oski") }}',
                        type: 'GET',
                        data: {
            ...
            $('#shakl').change(function () {
                ...
                if (semester_id && groupId && subject_id && shakl) {
                    $.ajax({
                        url: '{{ route("teacher.get-students-shakl-oski") }}',
                        type: 'GET',
                        data: {
                            semester_code: semester_id,
                            subject_id: subject_id,
