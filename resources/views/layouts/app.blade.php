        ...
        <div class="flex min-h-screen bg-gray-100 dark:bg-gray-900">
            ...
            <div class="flex-1 overflow-x-hidden overflow-y-auto sidebar-main-content">
                ...
                <div class="top-header-bar" style="display:flex;flex-direction:row;align-items:center;justify-content:flex-end;flex-wrap:nowrap;height:40px;"
                     x-data="{
                        notifOpen: false, langOpen: false, profileOpen: false,
                        posDropdown(btn, dd, w) {
                    ...
                    <!-- Til, Xabarnoma, Profil -->
                    <div class="top-header-right" style="display:flex;flex-direction:row;align-items:center;flex-wrap:nowrap;gap:6px;">

                        <!-- 1. Til -->
                        <div class="top-header-item" style="display:inline-block;">
                            <button x-ref="langBtn"
                                    @click.stop="langOpen = !langOpen; notifOpen = false; profileOpen = false; $nextTick(() => { if(langOpen) posDropdown($refs.langBtn, $refs.langDd, 160) })"
                            ...
                            <div x-ref="langDd" x-show="langOpen" x-cloak
                        ...
                        <!-- 2. Xabarnomalar -->
                        <div class="top-header-item" style="display:inline-block;">
                            <button x-ref="notifBtn"
                                    @click.stop="notifOpen = !notifOpen; langOpen = false; profileOpen = false; $nextTick(() => { if(notifOpen) posDropdown($refs.notifBtn, $refs.notifDd, 320) })"
                                    class="top-header-btn" style="display:inline-flex;flex-direction:row;align-items:center;">
                                <svg style="width:18px;height:18px;flex-shrink:0;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div x-ref="notifDd" x-show="notifOpen" x-cloak
                                 x-transition:enter="transition ease-out duration-100"
                                 x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
                                 x-transition:leave="transition ease-in duration-75"
                                 x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0"
                                 @click.outside="notifOpen = false"
                                 class="top-header-dropdown notif-dropdown">
                        ...
                        <!-- 3. Profil (strelkasiz) -->
                        <div class="top-header-item" style="display:inline-block;">
                            <button x-ref="profBtn"
                                    @click.stop="profileOpen = !profileOpen; langOpen = false; notifOpen = false; $nextTick(() => { if(profileOpen) posDropdown($refs.profBtn, $refs.profDd, 220) })"
                            ...
                            <div x-ref="profDd" x-show="profileOpen" x-cloak
                                 x-transition:enter="transition ease-out duration-100"
                                 x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
                                 x-transition:leave="transition ease-in duration-75"
                                 x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0"
                                ...
                                <div style="border-bottom:1px solid #e5e7eb;padding:2px 0;">
