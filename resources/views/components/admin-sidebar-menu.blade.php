...
<aside x-data="sidebarTheme()" :data-theme="theme"
    ...
    <nav class="flex-1 py-2 px-2 overflow-y-auto sidebar-nav"
        ...
        @if(($isTeacher || $hasActiveRole(['superadmin', 'admin', 'kichik_admin', 'registrator_ofisi', 'dekan', 'kafedra_mudiri', 'fan_masuli'])) && !$hasActiveRole(['oquv_bolimi', 'oquv_bolimi_boshligi', 'tyutor', 'oqituvchi']))
