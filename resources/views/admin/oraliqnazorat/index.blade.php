<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.oraliqnazorat.create') }}" class="btn btn-primary">
    ...
    <div class="py-12">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <form id="search-form" method="GET" action="{{ route('admin.oraliqnazorat.index') }}"
                                        ...
                                        @foreach ($oraliqnazorats as $oraliqnazorat)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                    <form action="{{ route('admin.oraliqnazorat.delete', $oraliqnazorat->id) }}"
                                                    ...
                                                    <a type="button"
                                                        href="{{ route('admin.oraliqnazorat.edit', $oraliqnazorat->id) }}"
                                                    ...
                                                    <a type="button"
                                                        href="{{ route('admin.oraliqnazorat.grade', $oraliqnazorat->id) }}"
