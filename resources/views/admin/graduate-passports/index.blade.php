<x-app-layout>
                ...
                <div class="filter-container">
                    <div class="filter-row">
                        ...
                        <div class="filter-item" style="min-width:160px;">
                            <label class="filter-label"><span class="fl-dot" style="background:#7c3aed;"></span> Tekshiruv</label>
                            <select id="review-status-select" class="filter-input">
                                <option value="">Barchasi</option>
                        ...
                        <div class="filter-item" style="min-width:180px;">
                            <label class="filter-label">&nbsp;</label>
                            <button type="button" class="btn-apply" style="background:linear-gradient(135deg,#16a34a,#22c55e);box-shadow:0 2px 4px rgba(22,163,74,0.25);" onclick="exportExcel()">
                        ...
                        <div class="filter-item" style="min-width:180px;">
                            <label class="filter-label">&nbsp;</label>
                            <button type="button" class="btn-apply" style="background:linear-gradient(135deg,#2563eb,#3b82f6);box-shadow:0 2px 4px rgba(37,99,235,0.25);" onclick="downloadZip()">
                                <svg style="width:15px;height:15px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
    ...
    <script>
        ...
        function exportExcel() {
            ...
            var rs = $('#review-status-select').val();
            var q = ($('#search-input').val() || '').trim();
            if (fac) params.push('faculty_id=' + encodeURIComponent(fac));
            if (grp) params.push('group_id=' + encodeURIComponent(grp));
            if (st) params.push('status=' + encodeURIComponent(st));
            if (rs) params.push('review_status=' + encodeURIComponent(rs));
        ...
        function applyFilter() {
            ...
            var params = {
                ...
                review_status: $('#review-status-select').val() || '',
