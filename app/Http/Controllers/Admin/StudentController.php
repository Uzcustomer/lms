...
class StudentController extends Controller
{
    ...
    public function saveAdmissionData(Request $request, Student $student)
    {
        ...
        $data = $request->only([
            ...
            'iqtidori_boshqa', 'sport_qobiliyat_boshqa', 'sport_boshqa',
        ]);

        // Massiv maydonlar (checkbox guruhlar) — Model casts orqali JSON ga aylanadi
        $data['chet_tillari'] = $request->input('chet_tillari', []) ?: null;
        $data['iqtidori'] = $request->input('iqtidori', []) ?: null;
        $data['sport_qobiliyat'] = $request->input('sport_qobiliyat', []) ?: null;
        ...
        $skipUpper = ['tugilgan_sana', 'passport_sana', 'email', 'kenglik', 'uzunlik',
                      'chet_tillari', 'iqtidori', 'sport_qobiliyat'];
