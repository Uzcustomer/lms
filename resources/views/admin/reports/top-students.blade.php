<x-app-layout>
                ...
                <div class="filter-container">
                    ...
                    <div class="filter-row">
                        ...
                        <div class="filter-item" style="min-width: 130px;">
                            ...
                            <select id="score_limit" class="select2" style="width: 100%;">
                                @foreach([100, 95, 90, 85, 80, 70, 60] as $limit)
                                    <option value="{{ $limit }}" {{ $limit == 90 ? 'selected' : '' }}>&lt; {{ $limit }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div id="result-area">
                    ...
                    <div id="table-area" style="display:none;">
                        <div style="padding:10px 20px;background:#fef9c3;border-bottom:1px solid #fde68a;display:flex;align-items:center;gap:12px;">
                            <span id="total-badge" class="badge" style="background:#f59e0b;color:#fff;padding:6px 14px;font-size:13px;border-radius:8px;"></span>
    ...
    <script>
        ...
        function getFilters() {
            ...
            return {
                ...
                score_limit: $('#score_limit').val() || 90,
        ...
        function loadReport(page) {
            ...
            $.ajax({
                url: '{{ route("admin.reports.top-students.data") }}',
                type: 'GET',
                data: params,
                timeout: 120000,
                ...
                error: function(xhr) {
                    ...
                    console.error('Top students report error:', xhr.status, xhr.responseText ? xhr.responseText.substring(0, 500) : '');
                }
            });
        }
        ...
        function downloadExcel(type) {
            ...
            window.location.href = '{{ route("admin.reports.top-students.data") }}?' + query;
        }
    ...
    <style>
        ...
        .sort-icon.active { font-size: 11px; opacity: 1; color: #f59e0b; }
        ...
        .journal-table tbody tr:hover { background: #fefce8 !important; box-shadow: inset 4px 0 0 #f59e0b; }
        .journal-table td { padding: 10px 10px; vertical-align: middle; line-height: 1.4; }
        .td-num { padding-left: 16px !important; font-weight: 700; color: #f59e0b; font-size: 13px; }
