            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="text-2xl font-bold">{{ __('Xush kelibsiz!') }}</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                        ...
                        <div class="bg-green-100 p-4 rounded-lg text-center">
                            <h4 class="text-lg font-semibold mb-2">{{ __('Qoldirgan darslar soni') }}</h4>
                            <p class="text-3xl font-bold text-green-600">{{ $totalAbsent }} {{ __('ta') }}
                                </p>
                        </div>
                        <div class="bg-yellow-100 p-4 rounded-lg text-center">
                            <h4 class="text-lg font-semibold mb-2">{{ __('Qayta topshirishlar soni') }}</h4>
                            <p class="text-3xl font-bold text-yellow-600">{{ $debtSubjectsCount }} {{ __('ta') }}</p>
                        </div>
                    </div>

                    <div class="bg-white shadow rounded-lg p-6 mb-6">
                        <h4 class="text-lg font-semibold mb-4">{{ __('Tezkor havolalar') }}</h4>
                    ...
                    <div class="bg-white shadow rounded-lg p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h4 class="text-lg font-semibold">{{ __("Ish e'lonlari") }}</h4>
                            <a href="{{ route('student.job-listings') }}" class="text-sm text-indigo-600 hover:text-indigo-800 font-medium">{{ __('Barchasi') }}</a>
                        </div>
                        <div class="text-center py-8">
                            ...
                            <p class="mt-3 text-base text-gray-600">{{ __("Ushbu havola orqali bo'sh ish o'rinlarini ko'rishingiz mumkin") }}</p>
