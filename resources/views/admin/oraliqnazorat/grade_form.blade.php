            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 pt-2 bg-white border-b border-gary-200">
                    ...
                    <div class="flex w-full">
                        <div class="w-3/4">
                            <form method="POST" class="inline" action="{{ route('admin.oraliqnazorat.grade.save') }}">
                                @csrf
                                ...
                                <dl class="divide-y divide-gray-100">
                                    ...
                                    @foreach ($students as $student)
                                        <div class="px-2 py-2 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                            ...
                                            @if (($oraliqnazorat->status == 0 || auth()->user()->hasRole(['admin'])) && !($ynLocked ?? false))
                            ...
                            <div class="ml-1" style="border-left:2px black solid">
                                <dl class="divide-y divide-gray-100">
                                    ...
                                    <div class="px-2 py-2 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                        ...
                                        <dd class="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0">
                                            {{$oraliqnazorat->teacher_short_name}}
                                        </dd>
                                    </div>
                                    <div class="px-2 py-2 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
