...
class ExamTestImport implements ToCollection, WithHeadingRow, WithValidation
{
    public $error = [];
    ...
    public function collection(Collection $rows)
    {
        ...
        foreach ($rows as $row) {
            ...
            $exam_test = ExamTest::
                ...
                ->first();
            if (empty($exam_test)) {
                $row['error'] = "Bu ma'lumotlarga test topilmadi";
                $this->error[] = $row;
        ...
        ExamTest::whereIn('id', $test_ids)->update([
            'status' => 1,
