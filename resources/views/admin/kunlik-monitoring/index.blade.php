<x-app-layout>
    ...
    <style>
        ...
        .km-stat.km-stat-warn { background: linear-gradient(135deg, #fffbeb, #fef3c7); border-color: #fcd34d; }
        .km-stat.km-stat-warn .km-stat-value { color: #b45309; }
        ...
        .km-table tbody tr.km-row-warn { background: #fffbeb; }
        .km-table tbody tr.km-row-warn:hover { background: #fef9c3; }
        ...
        .km-badge-warn { background: #fef9c3; color: #854d0e; border: 1px solid #fde047; }
    ...
    <div class="km-wrap">
        <div class="km-card">
            ...
            <div class="km-totals" id="kmTotals" style="display:none;">
                ...
                <div class="km-stat" id="kmStatWarning">
                    <div class="km-stat-label">Ogohlantirish</div>
                    <div class="km-stat-value" id="kmTotWarning">0</div>
                </div>
            </div>
            ...
            <div class="km-table-wrap">
                <table class="km-table">
                    ...
                    <tbody id="kmTbody">
                        <tr>
                            <td colspan="8" class="km-empty">Sana oralig'ini tanlang va "Yuklash" tugmasini bosing.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    (function(){
        ...
        function statusBadge(s) {
            ...
            if (s === 'warning') return '<span class="km-badge km-badge-warn">Ogohlantirish</span>';
        ...
        function rowClass(s) {
            ...
            if (s === 'warning') return 'km-row-warn';
            return '';
        }
        ...
        async function loadData() {
            ...
            $('kmTbody').innerHTML = `<tr><td colspan="8" class="km-loading"><span class="km-spinner"></span>Yuklanmoqda...</td></tr>`;
            ...
            try {
                ...
                if (!r.ok || !body.success) {
                    ...
                    $('kmTbody').innerHTML = `<tr><td colspan="8" class="km-empty" style="color:#b91c1c">Xato: ${msg}</td></tr>`;
                    return;
                }
                ...
                $('kmTotWarning').textContent = totals.warning_count ?? 0;
                ...
                $('kmStatWarning').className = 'km-stat ' + ((totals.warning_count ?? 0) > 0 ? 'km-stat-warn' : 'km-stat-ok');
                $('kmTotals').style.display = 'flex';

                if (days.length === 0) {
                    $('kmTbody').innerHTML = `<tr><td colspan="8" class="km-empty">Ma'lumot topilmadi.</td></tr>`;
                    return;
                }
                ...
                $('kmTbody').innerHTML = `<tr><td colspan="8" class="km-empty" style="color:#b91c1c">Xato: ${e.message}</td></tr>`;
            } finally {
        ...
        async function openMissing(date) {
            ...
            try {
                ...
                html += `<div class="km-section">
                    <h3 class="km-section-title">
                        LMS sync → Mark bosqichida tushib qolgan — FARQ (${missingMark.length})
                        <span style="font-weight:500;color:#64748b;font-size:11px;margin-left:6px;">
                            yuklanishi kerak bo'lib unutilganlar (jurnalda baho yo'q)
                        </span>
                    </h3>`;
                ...
                html += `<div class="km-section">
                    <h3 class="km-section-title">
                        Ogohlantirish — yuklanmagan, lekin sababli (${warnings.length})
                        <span style="font-weight:500;color:#64748b;font-size:11px;margin-left:6px;">
                            jurnalda allaqachon baho bor — talaba adashib qayta topshirgan yoki darsdagi baho yuqori (farqqa kirmaydi)
                        </span>
                    </h3>`;
                if (warnings.length === 0) {
                    html += `<div style="color:#15803d;font-size:12px;font-weight:600;">Ogohlantirish yo'q ✓</div>`;
                } else {
                    html += `<table class="km-mini-table"><thead><tr>
                        <th>attempt_id</th>
                        <th>HEMIS ID</th>
