        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-4 sm:p-6 bg-white border-b border-gray-200">
                    ...
                    @if($applications->isEmpty())
                        <div class="text-center py-12">
                            ...
                            <p class="text-sm text-gray-600 font-medium">
                                {{ __("Sizda hozircha qayta o'qish jurnali yo'q") }}
                            </p>
                    ...
                    @else
                        {{-- Desktop: jadval (har ariza = alohida qator) --}}
                        <div class="hidden sm:block overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('Semestr') }}</th>
                                ...
                                @foreach($applications as $i => $a)
                                    @php $g = $a->retakeGroup; @endphp
                                    <tr class="hover:bg-red-50/30 transition">
                                        <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500 font-medium">{{ $i + 1 }}</td>
                                        <td class="px-4 py-3 text-sm font-semibold text-gray-900">{{ $a->subject_name }}</td>
                                        <td class="px-4 py-3 text-xs text-gray-700">{{ $a->semester_name }}</td>
                                        ...
                                        <td class="px-4 py-3 text-right whitespace-nowrap">
                                            <a href="{{ route('student.retake-journal.show', $a->id) }}"
                        ...
                        {{-- Mobile: kartochkalar (har ariza = alohida kartochka) --}}
                                ...
                                <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                                    <div class="px-4 py-3 bg-gradient-to-r from-red-600 to-red-700 text-white">
                                        <div class="flex items-center justify-between gap-2">
                                            ...
                                            <span class="text-[10px] px-2 py-0.5 rounded-full bg-white/20 font-semibold">{{ $a->semester_name }}</span>
                                        </div>
