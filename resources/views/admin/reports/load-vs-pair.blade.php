<x-app-layout>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div id="result-area">
                    ...
                    <div id="loading-state" style="display:none;padding:60px 20px;text-align:center;">
                        ...
                        <p style="color:#2b5ea7;font-size:14px;margin-top:16px;font-weight:600;">API dan ma'lumot olinmoqda...</p>
    ...
    <script>
        ...
        function loadReport(page) {
            ...
            $.ajax({
                url: '{{ route("admin.reports.load-vs-pair.data") }}',
                type: 'GET',
                data: params,
                timeout: 300000,
                ...
                error: function(xhr) {
                    ...
                    console.error('Load vs Pair report error:', xhr.responseText);
        ...
        function downloadExcel() {
            ...
            window.location.href = '{{ route("admin.reports.load-vs-pair.data") }}?' + query;
        }
