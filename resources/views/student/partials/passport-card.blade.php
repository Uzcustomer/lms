    ...
    <div x-show="showPassportForm" x-transition class="border-t border-gray-200 pt-5">
        ...
        <form method="POST" action="{{ route('student.passport.store') }}" enctype="multipart/form-data" id="passportForm">
            ...
            <div class="mb-4 p-4 bg-red-50 border border-red-300 rounded-lg flex items-start gap-3">
                ...
                <p class="text-sm text-red-800 font-medium">Xorijga chiqish yoki yashil pasportingizdan olib aniqlik bilan to'ldiring, bu ma'lumotlar diplom va boshqa muhim hujjatlarda rasmiylashtiriladi!</p>
            </div>
