<x-teacher-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('teacher.independent.create') }}" class="btn btn-primary">
    ...
    <div class="py-12">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <form id="search-form" method="GET" action="{{ route('teacher.independent.index') }}"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select name="group" id="group" class="w-full rounded-md select2">
                                ...
                                <option value="{{ $groupItem->group_hemis_id }}"
                                    {{ request('group') == $groupItem->group_hemis_id ? 'selected' : '' }}>
                                    {{ $groupItem->name }}
                                </option>
                                @endforeach
                            </select>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            ...
                                            <a type="button"
                                                href="{{ route('teacher.independent.grade', $independent->id) }}"
    ...
    $(document).ready(function() {
        ...
        $('#group').change(function() {
            ...
            if (groupId) {
                ...
                $.ajax({
                    url: '{{ route("teacher.get-semesters-new-hemis") }}',
                    type: 'GET',
                    data: {
                        group_id: groupId
                    },
        ...
        $('#semester').change(function() {
            ...
            if (semesterId && groupId) {
                populateDropdown(
                    '{{ route("teacher.get-subjects-new-hemis") }}', {
