    ...
    <div class="py-6">
        <div class="w-full px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
                <div class="test-subject-card xl:col-span-2 overflow-hidden">
                    <div class="test-subject-card-head">
                        <h2 class="text-lg font-bold text-slate-900">Biriktirilgan guruhlar</h2>
                        <p class="text-sm text-slate-500 mt-1">Shu test fan ko‘rinadigan guruhlar ro‘yxati.</p>
                    </div>
                    <div class="p-5">
                                ...
                                <div class="rounded-2xl border border-slate-200 bg-slate-50/70 px-4 py-4">
                                    <div class="flex items-start justify-between gap-3">
                                        <div>
                                            ...
                                            <div class="text-xs text-slate-500 mt-2">HEMIS ID: {{ $group->group_hemis_id ?: '-' }}</div>
                                        </div>
                                        <span class="test-subject-chip blue">Guruh</span>
                                    </div>
                                </div>
                            @empty
                ...
                <div class="test-subject-card overflow-hidden">
                    <div class="test-subject-card-head">
                        <h2 class="text-lg font-bold text-slate-900">Asosiy ma’lumotlar</h2>
                        <p class="text-sm text-slate-500 mt-1">Modul haqida qisqa ma’lumot.</p>
                    </div>
                                ...
                                <tr class="lesson-row">
                                    <td class="px-4 py-4">
                                        <input type="number"
                                               ...
                                               min="1"
                                               name="topic_order"
                                               value="{{ old('topic_order', $lesson->topic_order) }}"
                                               class="test-subject-input min-w-[72px]">
                                    </td>
                                    <td class="px-4 py-4">
                                        <input type="date"
                                               form="lesson-update-{{ $lesson->id }}"
