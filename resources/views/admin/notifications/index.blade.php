                        ...
                        <form method="GET" action="{{ route('admin.notifications.index') }}" class="flex-1 flex items-center gap-2">
                            ...
                            <div class="flex-1 relative">
                                ...
                                <input type="text" name="search" value="{{ $search }}"
                                       ...
                                       class="w-full pl-9 pr-3 py-2 text-sm border border-gray-200 rounded-lg bg-gray-50 focus:bg-white focus:border-blue-400 focus:ring-1 focus:ring-blue-400 transition-colors">
                            </div>
                            @if($search)
