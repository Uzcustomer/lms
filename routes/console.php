...
// HEMIS exam grades sync — baholarni HEMIS dan tortib hemis_exam_grades jadvaliga saqlash (har kuni 22:00 da)
Schedule::command('hemis:sync-exam-grades')->dailyAt('22:00')->withoutOverlapping(120);
