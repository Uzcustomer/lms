<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.independent.create') }}" class="btn btn-primary">
                {{ __('Mustaqil ta\'lim qo\'shish') }}
            </a>
    ...
    <div class="py-12">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <form id="search-form" method="GET" action="{{ route('admin.independent.index') }}"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select name="department" id="department" class="w-full rounded-md select2">
                                ...
                                <option value="{{ $departmentItem->department_hemis_id }}"
                                    {{ request('department') == $departmentItem->department_hemis_id ? 'selected' : '' }}>
                                    {{ $departmentItem->name }}
                                </option>
                                @endforeach
                            </select>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                            {{$independent->user?->name ??$independent->teacher?->full_name ??"Auto yaratilgan"}}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            ...
                                            <!-- <a type="button"
                                                                                        href="{{ route('admin.independent.edit', $independent->id) }}"
                                            ...
                                            <a type="button"
                                                href="{{ route('admin.independent.grade', $independent->id) }}"
    ...
    $(document).ready(function() {
        ...
        $('#department').change(function() {
            ...
            if (departmentId) {
                populateDropdown(
                    '{{ route("admin.get-groups-by-department-hemis") }}', {
        ...
        $('#group').change(function() {
            ...
            if (groupId) {
                ...
                $.ajax({
                    url: '{{ route("admin.get-semesters-new-hemis") }}',
                    type: 'GET',
                    data: {
                        group_id: groupId
                    },
        ...
        $('#semester').change(function() {
            ...
            if (semesterId && groupId) {
                populateDropdown(
                    '{{ route("admin.get-subjects-new-hemis") }}', {
