<x-student-app-layout>
    ...
    <style>
        ...
        @media (max-width: 640px) {
            ...
            /* Assessment table */
            .ae-table-wrap { border-radius: 10px; }
            .ae-table thead th { padding: 8px 10px; font-size: 10px; }
            .ae-table tbody td { padding: 8px 10px; font-size: 12px; }
            .ae-table .ae-date-cell { min-width: 160px; }
            .ae-table .ae-subject-cell { font-size: 11px; }
                            ...
                            <tbody>
                                <template x-for="(group, gi) in groupedAssessments" :key="gi">
                                    <template x-for="(item, ri) in group.items" :key="item._idx">
                                        <tr>
                                            {{-- T/r va Fan faqat birinchi qatorda (rowspan) --}}
                                            <template x-if="ri === 0">
