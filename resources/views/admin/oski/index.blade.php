<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <form action="{{ route('admin.oski.import') }}" method="POST" enctype="multipart/form-data"
            ...
            <a href="{{ route('admin.oski.create') }}" class="btn btn-primary">
                {{ __('OSKI qo\'shish') }}
            </a>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach (session('test_error') as $test_e)
                        <tr>
                            ...
                            <td class=" px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"> {{$test_e['date']}}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                {{$test_e['status']}}
                            </td>
    ...
    <div class="py-12">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <form id="search-form" method="GET" action="{{ route('admin.oski.index') }}" class="p-6 bg-gray-50">
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select name="status" id="status" class="w-full rounded-md select2">
                                <option value="2" {{ (request('status') ?? 2) == 2 ? 'selected' : '' }}>Hammasi
                                </option>
                    ...
                    <div class="mt-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div class="w-full sm:w-auto">
                            <label for="per_page" class="block sm:inline text-sm font-medium text-gray-700 mr-2">Har
                                bir
                                sahifada:</label>
                                                            ...
                                                            @foreach ($oskis as $oski)
                                                                <tr>
                                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                                        <form action="{{ route('admin.oski.delete', $oski->id) }}" method="POST"
                                                                            class="inline"
                                                                        ...
                                                                        <a type="button" href="{{ route('admin.oski.edit', $oski->id) }}"
                                                                        ...
                                                                        <a type="button" href="{{ route('admin.oski.grade', $oski->id) }}"
                                                                            ...
                                                                            <svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24"
                                                                                ...
                                                                                <path
                                                                                    d="M20 12v6a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12a2 2
                                                                                                                                                                                0 0 1 2 -2h9" />
                                                                            </svg>
                                                                        </a>
                                                                    ...
                                                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                                                        {{$oski->user?->name ?? $oski->dekan->full_name}}
                                                                    </td>
                                                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                                                        {{ $oski->grade_teacher ?? "???" }}
                                                                    </td>
